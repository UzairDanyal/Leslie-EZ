...
const CustomLayout = () => {
  ...
  return (
    ...
    >
      <div className='text-center text-white font-bold text-5xl mt-[30px] mb-11'>
        <h1>Become a Free Franchise Partner</h1>
      </div>
      {/* Top Logo and Title */}
      <div className="text-center flex gap-[100px] mb-10">
       
      <img src="/assets/images/left franchise.webp" alt="Logo" className="w-50 h-[160px] mx-auto" />
        <img src="/assets/images/logo.webp" alt="Logo" className="w-50 h-52 mx-auto" />
        <img src="/assets/images/right franchise.webp" alt="Logo" className="w-[150px] mt-8 h-[160px] mx-auto" />
